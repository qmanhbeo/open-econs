clear all
set more off
log using "C:\Users\manhn\AppData\Local\Temp\opencode\sysz.log", replace text
...
if _rc == 0 {
    ...
    matrix Zmat = e(Z)
    svmat double Zmat
    export delimited using "C:\Users\manhn\AppData\Local\Temp\opencode\sys_Z.csv", replace
...
if _rc == 0 {
    matrix Xmat = e(X)
    svmat double Xmat
    export delimited using "C:\Users\manhn\AppData\Local\Temp\opencode\sys_X.csv", replace
...
if _rc == 0 {
    matrix Ymat = e(Y)
    svmat double Ymat
    export delimited using "C:\Users\manhn\AppData\Local\Temp\opencode\sys_Y.csv", replace
...
if _rc == 0 {
    matrix Hmat = e(H)
    svmat double Hmat
    export delimited using "C:\Users\manhn\AppData\Local\Temp\opencode\sys_H.csv", replace
