*! qreg.do â€” Quantile regression parity fixtures for open-econs quantile_reg().
*! Stata/MP 17.0.  Estimators: qreg (median + 0.25), sqreg, bsqreg.
*!
*! DESIGN
*!   qreg y x1 x2, quantile(tau)
*!     - Coefficients: Barrodaleâ€“Roberts simplex (== R rq(method="br")).
*!     - Default SE (e(V)): sparsity/Powell-kernel Hallâ€“Sheather sandwich.
*!   sqreg  = simultaneous quantiles, bootstrap VCE (reps=20, seed fixed).
*!   bsqreg = single-quantile bootstrap VCE (reps=20, seed fixed).
*!
*! Two fixtures:
*!   qreg.dta       â€” qreg coefs + default SEs at tau in {0.25, 0.5}.
*!   qreg_boot.dta  â€” sqreg / bsqreg coefs + bootstrap SEs (set seed 20260719).
*!
